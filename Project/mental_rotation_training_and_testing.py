...
'''
filename = "label_weights_12deg" + str(n_hid) +".p"
cPickle.dump(label_weights, open( filename, "wb" ) )

filename = "activity_to_img_weights_12deg" + str(n_hid) +".p"
cPickle.dump(sim.data[conn].weights.T, open( filename, "wb" ) )

filename = "rotation_weights_12deg" + str(n_hid) +".p"
cPickle.dump(weights, open( filename, "wb" ) )

filename = "rotated_after_encoder_weights_12deg" + str(n_hid) +".p"
